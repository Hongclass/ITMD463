<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrderSummary.aspx.cs" Inherits="WingtipToys.OrderSummary" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <h1>Order Summary</h1>
                <p>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="OrderDS" ForeColor="#333333" GridLines="None">
                    ...
                    <asp:SqlDataSource ID="OrderDS" runat="server" ConnectionString="<%$ ConnectionStrings:WingtipToys %>" SelectCommand="SELECT CartItems.ProductId, Products.ProductName, Products.UnitPrice, CartItems.Quantity FROM CartItems INNER JOIN Users ON CartItems.CartId = Users.UserName INNER JOIN Products ON CartItems.ProductId = Products.ProductID"></asp:SqlDataSource>
                </p>
                        <p></p>
        <strong>
            ...
            <asp:Label ID="Label2" runat="server" EnableViewState="false"></asp:Label>
                ...
                <p>
                    ...
                    <asp:SqlDataSource ID="UserDS" runat="server" ConnectionString="<%$ ConnectionStrings:WingtipToys %>" SelectCommand="SELECT [UserName], [FirstName], [LastName], [Email] FROM [Users]"></asp:SqlDataSource>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-5">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txt_address" runat="server" 
                placeholder="1111 St Address" TextMode="MultiLine" CssClass="form-control" 
