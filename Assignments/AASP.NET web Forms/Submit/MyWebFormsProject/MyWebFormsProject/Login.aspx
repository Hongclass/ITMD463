<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="MyWebFormsProject.Login" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <p>No account? </p>
            <%-- Height="38px" Width="105px"--%>
            <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Create One" OnClick="btn_registration_Click" />
            <br />
            <br />
            <br />
